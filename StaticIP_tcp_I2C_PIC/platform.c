...
#define SSID_NAME                             "invitados"                  /* AP SSID */
#define SECURITY_TYPE                         SL_WLAN_SEC_TYPE_WPA_WPA2 /* Security type could be SL_WLAN_SEC_TYPE_OPEN */
#define SECURITY_KEY                          "ELKtanks54"                /* Password of the secured AP */


//#define SSID_NAME                             "simplelinkHost"                  /* AP SSID */
//#define SECURITY_TYPE                         SL_WLAN_SEC_TYPE_WPA_WPA2 /* Security type could be SL_WLAN_SEC_TYPE_OPEN */
//#define SECURITY_KEY                          "12345678"                /* Password of the secured AP */

//#define SSID_NAME                             "INFINITUMzj72"                  /* AP SSID */
//#define SECURITY_TYPE                         SL_WLAN_SEC_TYPE_WPA_WPA2 /* Security type could be SL_WLAN_SEC_TYPE_OPEN */
//#define SECURITY_KEY                          "b8d5924127"                /* Password of the secured AP */
